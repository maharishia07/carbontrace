 ...
 *
 * Android requires the persistent notification — it doubles as the user's
...
class TripRecordingService : Service() {
    ...
    private fun buildNotification(): Notification {
        ...
        return builder
            .setContentTitle("CarbonTrace — trip recording")
            .setContentText("Tracking this drive's CO₂. Tap to open.")
